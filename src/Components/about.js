        ...
        <> <div className="container my-5">
            <div className="container d-flex justify-content-center">
                <div className ="card" style={{width: "18rem"}}>
                     <img src="dp.jpeg" className ="card-img-top rounded" alt="dpimg" />
                    <div className ="card-body">
                            <h5 className ="card-title">Founder - <strong>TextUtils</strong> </h5>
                            <p className ="card-text">This Web App was created by <strong>Abhishek Kumar Singh</strong> </p>
